...
class GameState:
    ...
    def __init__(self, xlim=3, ylim=2, blocks=[(2, 1)]):
        self.xlim = xlim
        self.ylim = ylim
        self._board = [[0] * ylim for _ in range(xlim)]
        for block in blocks:
            self._board[block[0]][block[1]] = 1  # block lower-right corner
        self._parity = 0
    ...
    def _get_blank_spaces(self):
        ...
        return [(x, y) for y in range(self.ylim) for x in range(self.xlim)
