import solution
from solution import boxes, column_units, row_units, eliminate_naked_twins_numbers, display, \
    test_valid_solution
import unittest
...
class TestNakedTwins(unittest.TestCase):
    ...
    def test_eliminate_naked_twin_numbers(self):
        column = column_units[2]
        values = eliminate_naked_twins_numbers(column, TestNakedTwins.before_naked_twins_1)
        #for box in column:
        #    print('{}: {}, {}'.format(box, TestNakedTwins.before_naked_twins_1[box], values[box]))
        assert values['D3'] == '79'
        assert values['E3'] == '79'

        row = row_units[2]
        values = eliminate_naked_twins_numbers(row, TestNakedTwins.before_naked_twins_2)
        #for box in row:
        #    print('{}: {}, {}'.format(box, TestNakedTwins.before_naked_twins_2[box], values[box]))
        assert values['C5'] == '79'
        assert values['C6'] == '79'
...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    def test_01_solutions_are_valid(values):
        assert test_valid_solution(TestDiagonalSudoku.solved_diag_sudoku)
