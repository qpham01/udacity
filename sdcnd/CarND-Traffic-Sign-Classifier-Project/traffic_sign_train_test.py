...
from traffic_sign_model import VERSION_DESCRIPTION, L2_REG_STREGTH, MU, SIGMA, evaluate, \
    LEARNING_RATE, EPOCHS, BATCH_SIZES, BETA, x, y, training_operation, \
    loss_operation, keep_prob, softmax, accuracy_operation

from traffic_sign_data import X_TRAIN, X_VALID, X_TEST, Y_TRAIN, Y_VALID, Y_TEST, \
    TRAIN_RATIO, rgb_to_gray, USE_GRAYSCALE
    ...
    for epochs in EPOCHS:
        ...
        with tf.Session() as sess:
            ...
            hyper_dict = {'epochs' : epochs, 'batch size' : batch_size, 'learning rate' : \
                ...
                L2_REG_STREGTH, 'beta': BETA, 'mu': MU, 'sigma': SIGMA}
