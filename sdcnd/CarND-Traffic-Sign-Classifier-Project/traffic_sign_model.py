...
version_description = 'Added drop out, expanded network to 24 and 72 convolution depth, Adam optimizer with l2_reg_strength 0.5'
...
def LeNetTraffic(x, keep_prob):
    ...
    # Convolutional. Input = 32x32x3. Output = 28x28x24.
